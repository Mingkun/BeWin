...
def main():
    ...
    log_path = Path(args.log_path).resolve() if args.log_path else (Path(configured_log_path).expanduser().resolve() if configured_log_path else (base_dir / 'logs' / 'oauth_callback_debug.log'))
